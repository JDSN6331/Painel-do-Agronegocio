...
const NewsCard = ({ title, summary, imageUrl, articleUrl, source, pubDate }: NewsCardProps) => {
  return (
    <div
      className="glass-card news-card flex flex-col h-full group"
    >
      <div className="relative h-44 overflow-hidden">
        <img
          ...
          onError={(e) => {
            // Fallback to default local image on error
      ...
      <div className="flex flex-col flex-1 p-4">
        <h3 className="text-base font-semibold font-heading text-foreground mb-2 line-clamp-2 leading-tight group-hover:text-agro-gold transition-colors">
          {title}
        </h3>
