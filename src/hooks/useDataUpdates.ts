...
export function useGlobalLastUpdate() {
    ...
    useEffect(() => {
        ...
        // Fetch last update timestamp in the background for pages without direct data panels
        const fetchTimestamp = async () => {
            try {
                ...
                console.error("Error fetching background timestamp:", err);
            }
        };
        ...
        const interval = setInterval(fetchTimestamp, 60 * 1000);
