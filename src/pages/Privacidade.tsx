      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="container mx-auto px-4 pt-72 sm:pt-56 lg:pt-40 pb-12 flex-grow flex items-center justify-center">
          <div className="glass-panel p-8 md:p-12 max-w-4xl w-full rounded-2xl animate-in fade-in-50 slide-in-from-bottom-4 duration-500">
            <h1 className="text-xl md:text-4xl font-bold text-gold-gradient mb-6 md:mb-8 font-heading text-center">Política de Privacidade</h1>
            
            <div className="space-y-6 md:space-y-8 text-muted-foreground leading-relaxed text-sm md:text-[1.05rem]">
              ...
              <section>
                <h2 className="text-base md:text-xl font-bold text-foreground mb-2 md:mb-3 font-heading flex items-center gap-2">
