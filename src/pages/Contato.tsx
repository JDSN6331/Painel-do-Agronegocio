      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="container mx-auto px-4 pt-[260px] sm:pt-56 lg:pt-40 pb-12 flex-grow flex items-center justify-center">
          <div className="glass-panel p-8 md:p-12 max-w-2xl w-full rounded-2xl animate-in fade-in-50 slide-in-from-bottom-4 duration-500 text-center">
            <h1 className="text-2xl md:text-3xl font-bold text-gold-gradient mb-6 md:mb-8 font-heading">Contato</h1>
            
            <div className="space-y-6 md:space-y-8 text-muted-foreground leading-relaxed text-base md:text-lg">
