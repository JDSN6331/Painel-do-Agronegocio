      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="container mx-auto px-4 lg:pt-40 pt-56 pb-12 flex-grow flex items-center justify-center">
          <div className="glass-panel p-8 md:p-12 max-w-2xl w-full rounded-2xl animate-in fade-in-50 slide-in-from-bottom-4 duration-500 text-center">
            <h1 className="text-3xl font-bold text-gold-gradient mb-8 font-heading">Contato</h1>
            ...
            <div className="space-y-8 text-muted-foreground leading-relaxed text-lg">
              ...
              <div className="flex flex-col items-center justify-center gap-4 bg-background/40 p-6 rounded-xl border border-border/50">
                ...
                <a 
                  ...
                  className="text-xl md:text-2xl font-bold text-foreground hover:text-agro-gold transition-colors"
                >
